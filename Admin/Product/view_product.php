...
<body>
	...
	<div id="banner" >
		...
		while($row_pros=mysqli_fetch_array($result)){
			$ProductID = $row_pros['ProductID'];
			$ProductName = $row_pros['ProductName'];
			$ProductPrice = $row_pros['ProductPrice'];
			$ProductDescription = $row_pros['ProductDescription'];
			$CategoryID = $row_pros['CategoryID'];
			$ProductImage = $row_pros['ProductImage'];
			echo "
			
				<tr style='text-decoration: none'>
				<td><a href=''>$ProductID</a></td>
			<td><a href=''>$ProductName</a></td>
			<td><a href=''>$ProductPrice</a></td>
			<td><a href=''>$ProductDescription</a></td>
			<td><a href=''>$CategoryID</a></td>
			<td><img src='../../$ProductImage' style='
    width: 40px;
    height: 40px; '></td>
	        <td><a href='add_product.php?ProductID=$ProductID'>Delete</a></td>
				<td><a href='add_product.php?ProductID=$ProductID'>Update</a></td>
			</tr>
